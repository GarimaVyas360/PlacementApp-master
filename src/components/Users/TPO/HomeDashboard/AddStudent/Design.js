...
const TpoAddStudentDesign = ({navigation,submitAccount,validateFirstName,validateLastName,validateEmail,
                        ...
                        <View style={styles.activityListView}>
                            ...
                            <View>
                                <TextInput
                                    ...
                                    value={enrollment}
                                    onChangeText={ (text) => {
                                        setEnrollment(text.replace(/[\s]/g, ''));
                                        validateEnrollment(text);
                            ...
                            <View>
                                <TextInput
                                    ...
                                    onTextInput={ () => {  }}
                                    onChangeText={ (text) => { 
                                        setPassConf(text.replace(/[\s]/g, ''));
                                        validatePassConf(text);
                                        checkPassConf(text);
                                        checkPasswordChecker(password,text);
                                    } }
                                    selectionColor={dimensions.color.select_color}
                                    left={ <TextInput.Icon name="key-variant" color={"darkblue"} disabled={true} />}
    ...
    function formDataClear(allow) {
        if(submitAccount(firstName,lastName,gender,email,mobile,branch,enrollment,password,passConf)){
            setFirstName('');
            setLastName('');
            setEmail('');
            setMobile('');
