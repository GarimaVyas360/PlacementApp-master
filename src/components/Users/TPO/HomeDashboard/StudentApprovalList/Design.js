...
import { deleteStudentList, UserSignUp } from '../../../../../firebase/firestore/UserSignUp';

const StudentApprovalListDesign = ({ navigation, StudentData, departmentList }) => {
    ...
    React.useLayoutEffect(() => {
        navigation.setOptions({
            title: strings.onBoarding.student_approvallist, //Set Header Title
        });
    }, [navigation]);
                ...
                <View style={styles.listAction}>
                    <Button
                        ...
                        onPress={() => {
                            ...
                            UserSignUp(item.FirstName, item.LastName, item.Gender, item.Email, item.Password, item.Phoneno, item.Department, item.Enrollment);
                            deleteStudentList(item.key);
                        }}
                    >
                        {strings.buttons.approval}
                    </Button>
                </View>
            </View>
        );
...
export default StudentApprovalListDesign;