...
const TpoChattingDashboardDesign = ({ navigation, nav_title, group_name, user, user_type, department }) => {
    return (
        <View style={styles.mainContainer}>
            <View style={styles.container}>
                <Divider style={{ height: 0.5, backgroundColor: 'gray', marginBottom: 1 }}></Divider>
                <ScrollView contentContainerStyle={styles.scrollView}>
                    <View style={styles.division} onStartShouldSetResponder={() => { navigation.navigate('TpoChattingGroupActivity', { group: group_name, department: department, user: user, user_type: user_type }) }}>
