...
const StudentBottomNavDesign = ({ navigation, Key, users, Email, Password, FirstName, LastName, Department, Enrollment, Gender, Phoneno }) => {
  // const adminTitle = 'Welcome Admin...';
  const user = users;
  // const email = email;
  // console.log("email address" + );
  const adminTitle = 'Welcome ' + user;
  const Key1 = () => <StudentChattingDashboardActivity navigation={navigation} nav_title={adminTitle} user={user} user_type={strings.users.admin} />;
