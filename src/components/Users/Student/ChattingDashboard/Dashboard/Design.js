...
const StudentChattingDashboardDesign = ({ navigation, nav_title, group_name, user, user_type, department }) => {
        ...
        <View style={styles.mainContainer}>
            <View style={styles.container}>
                ...
                <ScrollView contentContainerStyle={styles.scrollView}>
                    <View style={styles.division} onStartShouldSetResponder={() => { navigation.navigate('StudentChattingGroupActivity', { group: group_name, department: department, user: user, user_type: user_type }) }}>
