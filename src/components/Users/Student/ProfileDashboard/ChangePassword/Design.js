...
const StudentProfileChangePasswordDesign = ({ navigation, submitChangePass, ValidateOldPass, ValidateConfirmPass, ValidateNewPass,
            ...
            <ScrollView style={styles.container}>
                ...
                <View style={styles.baseContainer}>
                    <View style={styles.setCodeView}>
                        ...
                        >
                            <TouchableOpacity onPress={() => { navigation.replace('AdminProfileSetSecurityCodeActivity') }}>
...
export default StudentProfileChangePasswordDesign;;