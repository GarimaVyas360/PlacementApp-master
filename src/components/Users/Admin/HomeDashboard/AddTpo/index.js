...
const AddTpoActivity = ({ navigation }) => {
    ...
    return (
        <AddTpoDesign
            submitAccount={
                (firstName, lastName, email, mobile, branch, password, passConf) =>
                    submitAccount(firstName, lastName, email, mobile, branch, password, passConf)
            }
    ...
    function submitAccount(firstName, lastName, email, mobile, branch, password, passConf) {
