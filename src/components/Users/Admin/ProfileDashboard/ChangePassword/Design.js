...
const AdminProfileChangePasswordDesign = ({ navigation, submitChangePass, ValidateOldPass, ValidateConfirmPass, ValidateNewPass,
...
export default AdminProfileChangePasswordDesign;;