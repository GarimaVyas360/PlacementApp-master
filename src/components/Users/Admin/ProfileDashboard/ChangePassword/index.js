...
import { updatePassword } from '../../../../../firebase/firestore/UserSignUp';
import strings from '../../../../../res/strings';
import AdminProfileChangePasswordDesign from './Design';

const AdminProfileChangePasswordActivity = ({ route, navigation }) => {
    ...
    return (
        <AdminProfileChangePasswordDesign
    ...
    function submitChangePass(oldPass, newPass, confirmPass) {
        ...
        if (ValidateOldPass(oldPass).isValidate && ValidateNewPass(newPass, oldPass).isValidate
            ...
            navigation.replace('AdminProfileDashboardActivity');
...
export default AdminProfileChangePasswordActivity;