...
const StudentProfileEditDesign = ({ navigation, submitEditProfileStudent, validateFirstName, validateLastName, validateEmail
                ...
                <View style={styles.baseContainer}>
                    ...
                    <View style={styles.submitButton} >
                        <Button
                            ...
                            mode="contained"
                            onPress={() => {
                                submitEditProfileStudent(firstName, lastName, email, mobile, key);
                                validateFirstName(firstName);
                                checkFirstName(firstName);
                                validateLastName(lastName);
                                validateEmail(email);
